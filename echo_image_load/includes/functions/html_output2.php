...
//EDITED FOR ECHO
    $image = '<img src="' . zen_output_string($src) . '" data-echo="' . zen_output_string($src) . '" alt="' . zen_output_string($alt) . '"';
...
// the image filename as default
//EDITED FOR ECHO
    $image = '<img data-src="' . zen_output_string($src) . '" data-echo="' . zen_output_string($src) . '" alt="' . zen_output_string($alt) . '"';
